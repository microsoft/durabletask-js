...
export class DurableTaskAzureManagedWorkerBuilder {
   ...
   */
  resourceId(resourceId?: string | null): DurableTaskAzureManagedWorkerBuilder {
...
export function createAzureManagedWorkerBuilder(
  ...
  if (taskHubName !== undefined) {
    ...
    return builder.endpoint(endpointOrConnectionString, taskHubName, credential).resourceId(resourceId);
  } else {
